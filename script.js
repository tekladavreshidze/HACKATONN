...
//     e.preventDefault();
//     $('.regOptions').toggleClass('d-none');
//     $('.reg_btn').toggleClass('d-none');
//     $('.logIn_btn').toggleClass('d-none');
// });

// $('.mepatrone').click(function (e) {
//     e.preventDefault();
//     $('.mepatroneReg').toggleClass('d-none');
//     $('.mepatrone').toggleClass('d-none');
//     $('.personali').toggleClass('d-none');
// });

// $('.personali').click(function (e) {
//     e.preventDefault();
//     $('.personaliReg').toggleClass('d-none');
//     $('.mepatrone').toggleClass('d-none');
//     $('.personali').toggleClass('d-none');
// });
...
//     e.preventDefault();
//     $('.logInOptions').toggleClass('d-none');
//     $('.reg_btn').toggleClass('d-none');
//     $('.logIn_btn').toggleClass('d-none');
// });
